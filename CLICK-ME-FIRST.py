...
status_label = tk.Label(card, textvariable=status, font=("Segoe UI", 9, "bold"),
                        fg="#fbbf24", bg="#171b2e")
status_label.pack(pady=10)

button = tk.Button(card, text="ACTIVATE", command=activate,
                   font=("Segoe UI", 10, "bold"), fg="white", bg="#6d5dfc",
                   activeforeground="white", activebackground="#7c6cff",
                   relief="flat", cursor="hand2")
button.pack(padx=18, fill="x", ipady=8, pady=(0, 16))

tk.Button(root, text="Open My Activation Server", command=open_server,
          font=("Segoe UI", 9, "bold"), fg="#b8bde0", bg="#171b2e",
          activeforeground="white", activebackground="#222844",
